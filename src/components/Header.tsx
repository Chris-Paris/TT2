...
export function Header({ language }: HeaderProps) {
  ...
  return (
    <header className="border-b bg-white mb-3">
      <div className="container max-w-lg lg:max-w-7xl mx-auto px-3 h-10 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-lg lg:text-xl font-bold text-[#d99a08]">TravellingTrip</h1>
        </div>
